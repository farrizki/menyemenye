                ...
                <tr>
                    ...
                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                        <?php if($item->berkas_path): ?>
                            <a href="<?php echo e(Storage::url($item->berkas_path)); ?>" target="_blank" class="text-gray-600 hover:text-blue-600" title="Lihat Berkas">
                    ...
                    <td class="px-4 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex items-center justify-center space-x-3">
                            <a href="<?php echo e(route('penggabungan.cetak-single-pdf', $item->id)); ?>" target="_blank" class="text-indigo-600 hover:text-indigo-900" title="Cetak">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" />
                                </svg>
                            </a>
                            
                            <form action="<?php echo e(route('penggabungan.destroy', $item->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini dan mengembalikan statusnya di Oracle?');" class="inline">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH D:\xampp\htdocs\aplikasi-final-sppt\resources\views/penggabungan/partials/laporan_table.blade.php ENDPATH**/ ?>