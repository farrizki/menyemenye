...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Laporan Penggabungan SPPT')); ?>
...
<?php endif; ?>
                    ...
                    <div id="laporanTableContainer">
                         <?php echo $__env->make('penggabungan.partials.laporan_table', ['laporan' => $laporan], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                function fetchLaporan(page = 1) {
                    ...
                    const url = new URL("<?php echo e(route('penggabungan.index')); ?>");
