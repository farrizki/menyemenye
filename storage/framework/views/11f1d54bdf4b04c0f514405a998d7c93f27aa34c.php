            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__empty_1 = true; $__currentLoopData = $preview['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr class="<?php echo e($rowClass); ?>">
                                        <td class="px-2 py-4 whitespace-nowrap text-sm"><?php echo e($item['formatted_nop']); ?></td>
                                        <td class="px-2 py-4 whitespace-nowrap text-sm"><?php echo e($item['thn_pajak_sppt']); ?></td>
                                        <td class="px-2 py-4 whitespace-nowrap text-sm"><?php echo e($item['data_preview']['nm_wp_sppt'] ?? '-'); ?></td>
                                        <td class="px-2 py-4 whitespace-nowrap text-sm"><?php echo e($item['data_preview']['alamat_wp'] ?? '-'); ?></td>
                                        <td class="px-2 py-4 whitespace-nowrap text-sm"><?php echo e($item['data_preview']['alamat_op'] ?? '-'); ?></td>
                                        <td class="px-2 py-4 whitespace-nowrap text-sm"><?php echo e(number_format($item['data_preview']['luas_bumi'] ?? 0, 0, ',', '.')); ?></td>
                                        <td class="px-2 py-4 whitespace-nowrap text-sm"><?php echo e(number_format($item['data_preview']['luas_bangunan'] ?? 0, 0, ',', '.')); ?></td>
                                        <td class="px-2 py-4 whitespace-nowrap text-sm">Rp <?php echo e(number_format($item['data_preview']['pbb_baku'] ?? 0, 0, ',', '.')); ?></td>
                                        <td class="px-2 py-4 whitespace-nowrap text-sm font-semibold"><?php echo e($item['status']); ?></td>
                                        <td class="px-2 py-4 whitespace-nowrap text-sm"><?php echo e($item['message']); ?></td>
                                    </tr>
                    ...
                    <div class="mt-6 space-y-4">
                        ...
                        <div class="p-4 border rounded-lg bg-blue-50 border-blue-300 text-sm">
                            ...
                            <ul class="list-disc list-inside ml-2">
                                ...
                                <li>Sudah Lunas (Hanya update Dafnom): <strong><?php echo e($lunasCount); ?></strong></li>
                    ...
                    <div class="flex justify-end mt-6">
                        <a href="<?php echo e(route('pembatalan.create')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-400 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-500 mr-2">
                            Kembali
                        </a>
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\epbb-tes\resources\views/pembatalan/preview.blade.php ENDPATH**/ ?>