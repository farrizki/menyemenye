    ...
    <div class="relative min-h-screen flex flex-col items-center justify-center">
        ...
        <main class="text-center">
            <div class="flex items-center justify-center mb-4">
                 <img src="<?php echo e(asset('images/Nganjuk.png')); ?>" alt="Logo BAPENDA" class="h-30 w-20">
            </div>
            ...
            <div class="mt-8">
                <a href="<?php echo e(route('login')); ?>" class="inline-block bg-blue-600 text-white font-bold py-3 px-8 rounded-lg text-lg hover:bg-blue-700 transition duration-300">
                    Masuk ke Aplikasi
                </a>
            </div>
        </main>
        ...
        <footer class="absolute bottom-0 w-full text-center p-4">
            <p class="text-sm text-gray-500 dark:text-gray-400">
                &copy; <?php echo e(date('Y')); ?> BAPENDA Kabupaten Nganjuk. All rights reserved.
            </p>
        </footer>
    </div>
</body>
</html>
<?php /**PATH D:\xampp\htdocs\aplikasi-final-sppt\resources\views/welcome.blade.php ENDPATH**/ ?>