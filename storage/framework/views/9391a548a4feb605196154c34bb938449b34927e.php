    ...
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            <?php $__empty_1 = true; $__currentLoopData = $laporan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="<?php echo e($data->status_proses == 'Gagal' ? 'bg-red-50' : ($data->status_proses == 'Lunas' ? 'bg-yellow-50' : '')); ?>">
                    ...
                    <td class="px-3 py-4 whitespace-nowrap text-sm text-right">Rp <?php echo e(number_format($data->pbb_yg_harus_dibayar_sppt ?? 0, 0, ',', '.')); ?></td>
                    ...
                    <td class="px-3 py-4 whitespace-nowrap text-sm">
                        <div class="flex items-center justify-center space-x-3">
                            <a href="<?php echo e(route('pembatalan.cetak-single-pdf', $data->id)); ?>" target="_blank" class="text-gray-500 hover:text-blue-600" title="Cetak PDF">
                            ...
                            <a href="<?php echo e(route('pembatalan.edit', $data->id)); ?>" class="text-gray-500 hover:text-green-600" title="Edit">
...
<?php /**PATH D:\xampp\htdocs\aplikasi-final-sppt\resources\views/pembatalan/partials/laporan_table.blade.php ENDPATH**/ ?>