...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Laporan Pengurangan SPPT')); ?>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $flashResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="<?php echo e($result['status'] == 'Berhasil' ? 'bg-green-50' : ($result['status'] == 'Gagal' || $result['status'] == 'Error' ? 'bg-red-50' : 'bg-yellow-50')); ?>">
                                                <td>
                                                    <?php echo e($result['formatted_nop'] ?? $result['nop'] ?? '-'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['type' => 'text','id' => 'searchInput','placeholder' => 'Cari NOP/Nama/Tahun/Alamat/SK/Jenis...','class' => 'w-full','value' => ''.e(request('search')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','id' => 'searchInput','placeholder' => 'Cari NOP/Nama/Tahun/Alamat/SK/Jenis...','class' => 'w-full','value' => ''.e(request('search')).'']); ?>
...
<?php endif; ?>
                    ...
                    <div id="laporanTableContainer">
                        <?php echo $__env->make('pengurangan.partials.laporan_table', ['laporanPengurangan' => $laporanPengurangan], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
        ...
        <script>
            ...
            function fetchLaporan(searchQuery = '', page = 1) {
                ...
                searchTimeout = setTimeout(() => {
                    const url = new URL("<?php echo e(route('laporan.pengurangan')); ?>");
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\aplikasi-final-sppt\resources\views/pengurangan/laporan.blade.php ENDPATH**/ ?>