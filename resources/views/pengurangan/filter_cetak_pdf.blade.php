<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Filter Laporan Pengurangan SPPT untuk Cetak') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('laporan.pengurangan.cetak-pdf-filtered') }}" method="GET" id="filterExportForm" target="_blank"> {{-- PERBAIKAN: Tambah ID form dan target --}}
                        <div class="mb-4">
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <x-primary-button type="submit">
                                {{ __('Export') }} {{-- PERBAIKAN: Tombol menjadi Export --}}
                            </x-primary-button>
                        </div>
                    </form>
                </div>
