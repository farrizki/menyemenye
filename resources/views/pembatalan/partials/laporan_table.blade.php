    ...
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            @forelse ($laporan as $data)
                <tr class="{{ $data->status_proses == 'Gagal' ? 'bg-red-50' : ($data->status_proses == 'Lunas' ? 'bg-yellow-50' : '') }}">
                    ...
                    <td class="px-3 py-4 whitespace-nowrap text-sm text-right">Rp {{ number_format($data->pbb_yg_harus_dibayar_sppt ?? 0, 0, ',', '.') }}</td>
                    ...
                    <td class="px-3 py-4 whitespace-nowrap text-sm">
                        <div class="flex items-center justify-center space-x-3">
                            <a href="{{ route('pembatalan.cetak-single-pdf', $data->id) }}" target="_blank" class="text-gray-500 hover:text-blue-600" title="Cetak PDF">
                            ...
                            <a href="{{ route('pembatalan.edit', $data->id) }}" class="text-gray-500 hover:text-green-600" title="Edit">
