                    ...
                    <form method="POST" action="{{ route('users.update', $user->id) }}">
                        ...
                        <div class="mt-4">
                         ...
                         <div class="mt-4">
                            ...
                            <x-text-input id="nip" class="block mt-1 w-full" type="text" name="nip" :value="old('nip', $user->nip)" required />
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="tgl_berlaku" class="block mt-1 w-full" type="date" name="tgl_berlaku" :value="old('tgl_berlaku', optional($user->tgl_berlaku)->format('Y-m-d'))" />
                        </div>
                                ...
                                @foreach ($permissions as $permission => $label)
                                    <label class="flex items-center">
                                        <input type="checkbox" name="permissions[]" value="{{ $permission }}" 
                                            @if(is_array($user->permissions) && in_array($permission, $user->permissions)) checked @endif
